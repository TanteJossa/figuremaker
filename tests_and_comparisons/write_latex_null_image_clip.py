...
def main():
    ...
    # Override image-clip to use null for the URL, matching native image-only copies.
    ...
    image_clip_inner["image_urls"][blob_id] = None
    ...
    print("\nClipboard MIME pairs (null URL in image-clip):")
    for k, v in pairs:
        print(f"  {k}: {len(v)} chars")

    if set_clipboard_data(pairs, png_bytes=png_bytes, text_fallback="LaTeX null image-clip test"):
