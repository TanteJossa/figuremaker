...
def main():
    ...
    # Build a simple graph (rectangle + line) WITHOUT an image placeholder.
    builder = SlidesBuilder()
    builder.add_rect(x=50, y=50, width=100, height=80, fill='#cfe2f3', stroke='#0b5394', stroke_width=2, obj_id='rect_1')
    builder.add_line(x1=50, y1=130, x2=150, y2=130, stroke='#000000', stroke_width=2, obj_id='line_1')
    ...
    if set_clipboard_data(pairs, png_bytes=png_bytes, text_fallback="Graph + LaTeX PNG"):
        print("\nClipboard set with graph shapes + PNG bytes. Paste into Google Slides.")
    else:
