...
def main():
    print("=========================================================")
    print("   WRITING GRID STEP 6: STEP 5 + BLUE SERIES CURVES      ")
    print("=========================================================")
    ...
    # Combine together
    resolved_array = title_ops + rect_ops + grey_lines + tick_ops + header_ops + green_lines + blue_lines
    ...
    success = set_clipboard_data(pairs, text_fallback="[Google Slides Kinematics Grid Step 6]")
    if success:
        print("\n[+] Success! Grid Step 6 (Step 5 + Blue Series) has been written.")
        print("    You can now paste (Ctrl+V) directly onto any active Google Slides slide.")
    else:
        print("\n[!] Error: Failed to write Step 6 payload.")
