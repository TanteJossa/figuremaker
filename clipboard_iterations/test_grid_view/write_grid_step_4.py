...
def main():
    print("=========================================================")
    print("   WRITING GRID STEP 4: STEP 3 + 6 SUB-GRAPH HEADERS     ")
    print("=========================================================")
    ...
    # Combine together
    resolved_array = title_ops + rect_ops + grey_lines + tick_ops + header_ops
    ...
    success = set_clipboard_data(pairs, text_fallback="[Google Slides Kinematics Grid Step 4]")
    if success:
        print("\n[+] Success! Grid Step 4 (Step 3 + Headers) has been written.")
        print("    You can now paste (Ctrl+V) directly onto any active Google Slides slide.")
    else:
        print("\n[!] Error: Failed to write Step 4 payload.")
