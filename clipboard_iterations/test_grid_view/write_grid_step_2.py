...
def main():
    print("=========================================================")
    print("      WRITING GRID STEP 2: STEP 1 + 48 GRIDLINES         ")
    print("=========================================================")
    
    # Load raw JSON structures
    ...
    # Combine together
    resolved_array = title_ops + rect_ops + grey_lines
    ...
    success = set_clipboard_data(pairs, text_fallback="[Google Slides Kinematics Grid Step 2]")
    if success:
        print("\n[+] Success! Grid Step 2 (Title + 6 Panel Frames + Gridlines) has been written.")
        print("    You can now paste (Ctrl+V) directly onto any active Google Slides slide.")
    else:
        print("\n[!] Error: Failed to write Step 2 payload.")
