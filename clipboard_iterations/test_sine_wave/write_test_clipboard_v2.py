...
if __name__ == "__main__":
    # V2: Includes the [14, 0] style prefix which is present in real Google Slides data
    resolved_array = [
        [3, "my_custom_rect_01", 6, [1.5, 0, 0, 1.0, 15000, 15000], [14, 0, 15, "#cfe2f3", 19, "#0b5394", 22, 200], "p"]
    ]
    ...
    set_clipboard_data(pairs, text_fallback="[Google Slides Rect V2]")
    print("\nTest rectangle V2 (with [14, 0] prefix) set! Please go to Google Slides and press Ctrl+V.")
