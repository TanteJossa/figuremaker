...
def main():
    print("=========================================================")
    print("  WRITING LATEX STEP 2: TITLE + FORMULAS + AXES          ")
    print("=========================================================")
    
    # Step 2: Title + 3 LaTeX formulas + Axes (X-axis and Y-axis)
    # Based on analysis of copied_structure.json:
    # - Axes use SHAPE_TYPE_153 (ID: 153) with arrowhead decorations
    # - Axes are grouped under Op Code 2 (logical grouping)
    
    resolved_array = [
        # === TITLE SECTION (from Step 1) ===
        ...
        # === LATEX FORMULAS SECTION (from Step 1) ===
        ...
        # === AXES SECTION (NEW in Step 2) ===
        # Horizontal X-Axis (axes_child_0) - SHAPE_TYPE_153 with arrowhead
        ...
        # Vertical Y-Axis (axes_child_1) - SHAPE_TYPE_153 with arrowhead
        ...
        # Logical grouping operation (Op Code 2) - groups the two axes together
    ...
    success = set_clipboard_data(pairs, text_fallback="[Google Slides LaTeX Step 2 - Axes]")
    
    if success:
        print("\n[+] Step 2 payload (Title + 3 LaTeX formulas + Axes) has been placed on the system clipboard!")
        ...
        print("    - X-Axis (horizontal, SHAPE_TYPE_153 with arrowhead)")
        print("    - Y-Axis (vertical, SHAPE_TYPE_153 with arrowhead)")
        print("    - Axes grouped under Op Code 2 logical grouping")
        print("\n    You can now paste (Ctrl+V) directly onto any active Google Slides slide canvas.")
        print("    Verify that the title, formulas, and axes appear correctly positioned.")
    else:
        print("\n[!] Error: Failed to write Step 2 payload to system clipboard.")
