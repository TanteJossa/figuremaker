...
def main():
    print("=========================================================")
    print("  WRITING LATEX STEP 3: TITLE + FORMULAS + AXES + GRIDLINES")
    print("=========================================================")
    
    # Step 3: Title + 3 LaTeX formulas + Axes + 11 Dashed Gridlines
    # Gridlines use SHAPE_TYPE_153 with dashed style (key 43 = 2)
    # Vertical gridlines: 5 lines at tx ∈ {71120, 132080, 193040, 254000, 314960}
    # Horizontal gridlines: 6 lines at ty ∈ {45085, 69215, 93345, 117475, 141605, 165735}
    ...
    resolved_array = [
        ...
        # === GRIDLINES SECTION (NEW in Step 3) ===
        ...
        # Logical grouping operation (Op Code 2) - groups all 11 gridlines together
    ...
    success = set_clipboard_data(pairs, text_fallback="[Google Slides LaTeX Step 3 - Gridlines]")
    
    if success:
        print("\n[+] Step 3 payload (Title + 3 LaTeX formulas + Axes + 11 Gridlines) has been placed on the system clipboard!")
        ...
        print("    - White background rectangles for each formula")
        print("    - X-Axis and Y-Axis (SHAPE_TYPE_153 with arrowheads)")
        print("    - 5 Vertical dashed gridlines (#DDDDDD, style 43=2)")
        print("    - 6 Horizontal dashed gridlines (#DDDDDD, style 43=2)")
        print("    - Gridlines grouped under Op Code 2 logical grouping")
        print("\n    You can now paste (Ctrl+V) directly onto any active Google Slides slide canvas.")
        print("    Verify that the title, formulas, axes, and gridlines appear correctly positioned.")
    else:
        print("\n[!] Error: Failed to write Step 3 payload to system clipboard.")
